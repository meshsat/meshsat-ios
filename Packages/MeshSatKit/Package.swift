...
let package = Package(
    ...
    targets: [
        ...
        .target(
            ...
            dependencies: [
                "MeshSatWire", "MeshSatCrypto", "MeshSatNet", "MeshSatHemb", "MeshSatProto", "MeshSatMeshtastic",
                .product(name: "Crypto", package: "swift-crypto"),
                .product(name: "_CryptoExtras", package: "swift-crypto"),
        ...
        .target(
            name: "MeshSatEngine",
            dependencies: [
                "MeshSatWire", "MeshSatCrypto", "MeshSatHemb", "MeshSatSatellite", "MeshSatNet", "MeshSatMsvqsc",
                .product(name: "Crypto", package: "swift-crypto"),
                .product(name: "Logging", package: "swift-log"),
        ...
        .target(
            name: "MeshSatHub",
            dependencies: [
                "MeshSatWire", "MeshSatCrypto", "MeshSatNet", "MeshSatEngine", "MeshSatReticulum",
                .product(name: "Crypto", package: "swift-crypto"),
                .product(name: "Logging", package: "swift-log"),
            ]
        ),
